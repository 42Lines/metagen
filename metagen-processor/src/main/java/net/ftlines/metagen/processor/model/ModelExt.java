...
public class ModelExt
{
	...
	public static boolean hasAnyAnnotation(Element e, Collection<String> annotationTypes)
	{
		return hasAnyAnnotation(e, annotationTypes.toArray(new String[annotationTypes.size()]));
	}
