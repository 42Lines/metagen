...
public class PersonTest extends MetaPackageTest
{
	...
	public void testBeanWithDeprecatedProperties() throws Exception
	{
		...
		assertNotNull(property1);
		assertNotNull("property1 is missing @Deprecated annotation", property1.getAnnotation(Deprecated.class));

		Field property2 = clazz.getDeclaredField("property2");
		assertNotNull(property2);
		assertNotNull("property2 is missing @Deprecated annotation", property2.getAnnotation(Deprecated.class));
	}
}
