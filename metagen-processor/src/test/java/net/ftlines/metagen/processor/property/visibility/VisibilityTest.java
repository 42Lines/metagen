...
public class VisibilityTest extends MetaPackageTest
{
	...
	@Test
	public void test() throws FileNotFoundException, SecurityException, IllegalArgumentException,
	...
	@Test
	public void testOverride() throws FileNotFoundException, SecurityException, IllegalArgumentException,
		ClassNotFoundException, NoSuchFieldException, IllegalAccessException
	{
		assertTrue(result.isClean());
